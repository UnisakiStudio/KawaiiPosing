...
## [3.0.11] - 2026-09-09
- アバタープリセットを追加（メルヴィ、ミダリス）
- うららのプリセットのモーション置き換えを修正
...
## [3.0.5] - 2026-03-17
- アバタープリセットを追加（アズキ、あのめあ、イメリス、うささき、京狐、ここあ、コロネ、サフィー、しずく、しらつめ、ソフィナ、ソラハ、デルタフレア、トラス、ナナセノワール、ナユ、ネメシス、フレア、プラチナ、真央、真冬、むんき、めいゆん、ヨル、ラスク、リーファ、りりか、竜胆、ルゼブル、ヴェール）

## [3.0.4] - 2026-01-31
- アバタープリセットを追加（クマリ、イチゴ、エルシオン、ラムネ、リルモワ、サバラム、Lapwing）

## [3.0.3] - 2026-01-11
- ライセンスのインストール・削除関連の機能を改善

## [3.0.2] - 2026-01-04
- Mac, Linux版のライセンス処理の不具合の修正
...
- アバターのプリセットを追加（マヌカ、しなの、桔梗、萌、ミルティナ、キプフェル、シフォン、ルミナ、エク、みみのこ）
